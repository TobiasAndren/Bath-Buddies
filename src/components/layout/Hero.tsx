...
export default function Hero({ className = "" }: HeroProps) {
  ...
  return (
    ...
    >
      <article className="w-[864px] h-[970px] relative bg-blue-50 overflow-hidden">
        <DuckScene
        ...
        />
        <aside className="absolute top-4 right-4 px-2.5 py-1 bg-neutral-50 rounded-[40px] flex justify-center items-center">
          ...
          <div className="flex justify-center items-center gap-2.5">
            <span className="justify-start text-[#8E8E8E] text-base font-bold font-['Inter']">
              3D
            </span>
          </div>
